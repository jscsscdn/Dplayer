var cms_player_fun = {
	...
	'dplayer_plus' : function(){
		document.write('<script src="//cdn.jsdelivr.net/gh/jscsscdn/Dplayer/hls.min.js"></script>');
		document.write('<script src="//cdn.jsdelivr.net/gh/jscsscdn/Dplayer/flv.min.js"></script>');
	},
	'dplayer_css' : function(){
		$("<link>").attr({ rel: "stylesheet",type: "text/css",href: "//cdn.jsdelivr.net/gh/jscsscdn/Dplayer/DPlayer.min.css"}).appendTo("head");
